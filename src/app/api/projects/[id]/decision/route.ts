...
6. 一个致命问题——如果只能问创始人一个问题，你会问什么？`,
  ...
  outside: `你是一个多视角分析助手。请从三个非投资人视角审视这个项目，
帮助投资人跳出专业视角的局限。
...
是否存在社会争议点？监管趋严会如何影响这个业务？`,
  ...
  mirror: `你是一位投资复盘专家。请根据投资人的历史判断记录，
...
如果历史判断记录较少，请如实说明，并基于现有信息给出力所能及的分析。`,
};
...
export async function POST(
  ...
  const projects = await query<ProjectRow>(
    `SELECT name, summary, process_stage, financial_data
  ...
  const generator = streamChat({
    ...
    apiKey: creds.apiKey,
    system: "你是一位资深的一级股权投资专家，输出使用简体中文与 Markdown 格式。",
